...
[DSI certificate](https://datasciencecertificate.ca) It contains a  Unix Shell script (EFF1.sh), a dataset of the parking infractions in the city of Toronto (parking.csv) and a video that shows how to run the script.
